...
const typeClasses = computed((): string => {
  ...
  switch (props.kind) {
    case "primary":
      result =
        "bg-green-400 text-white rounded-lg flex justify-center hover:opacity-90";
      break;
    case "border":
      result =
    ...
    case "danger":
      result =
        "text-red-500 border border-red-500 rounded-lg flex justify-center hover:opacity-60";
      break;
    case "current":
